...
import 'package:tiffen_wala_user/common/app_bloc_providers.dart';
import 'package:tiffen_wala_user/common/app_injector.dart';
import 'package:tiffen_wala_user/common/di/di_module.dart' as di;
import 'package:tiffen_wala_user/features/splash/splash_screen.dart';
...
void main() async {
  ...
  await AppInjector.init(appRunner: () => runApp(ProviderScope(child: MyApp())));
