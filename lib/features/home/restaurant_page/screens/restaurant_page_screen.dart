...
import 'package:tiffen_wala_user/features/home/restaurant_page/widgets/expandable_menu_widget.dart';
import 'package:tiffen_wala_user/features/home/restaurant_page/widgets/filter_list_widget.dart';
import 'package:tiffen_wala_user/features/home/restaurant_page/widgets/offer_widget.dart';
...
class _RestaurantPageScreenState extends ConsumerState<RestaurantPageScreen>
  ...
  void initState() {
    ...
    context
        ...
        .add(GetRestaurantDetailEvent(map: {"id": AppData.restaurantModel.id}));
      ...
      body: BlocConsumer<RestaurantDetailBloc, RestaurantDetailState>(
        listener: (context, state) {
          if (state is RestaurantDetailSuccess) {
            print(
                "><><><><><><><?<>>>>>>>>>>>>>${state.restaurantModel.category.length}");
          }
        },
              ...
              Expanded(
                child: CustomScrollView(
                  slivers: [
                              ...
                              child: IntrinsicHeight(
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Flexible(
                                      child: Text(
                                        AppData.restaurantModel.address,
                    ...
                    if (state is RestaurantDetailSuccess) ...[
                      SliverList.builder(
                        itemCount: state.restaurantModel.category.length,
                        itemBuilder: (context, index) {
                          return ExpandableMenuWidget(
                            categoryModel:
                                state.restaurantModel.category[index],
                          );
                        },
                      ),
                    ],
                        ...
                        children: [
                          Container(
                            decoration: BoxDecoration(
                              ...
                              border:
                                  Border.all(color: Colors.white38, width: 2.5),
                            ),
