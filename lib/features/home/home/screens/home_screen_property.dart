...
import 'package:tiffen_wala_user/features/home/chat_screens/chat_list_screen.dart';
...
import 'package:tiffen_wala_user/features/home/property_detail/property_detail_screen.dart';
import 'package:tiffen_wala_user/features/home/property_screens/add_property_screen.dart';
...
class _HomeScreenPropertyState extends ConsumerState<HomeScreenProperty> {
  ...
  final List<String> imageUrls = [
    "assets/images/pg_banner_one.jpg",
    "assets/images/pg_banner_two.jpg",
  ];
                    ...
                    child: Row(
                      children: [
                        ...
                        InkWell(
                          ...
                          onTap: () {
                            context.pushScreen(nextScreen: ChatListScreen());
                          },
                          child: Container(
                            height: 30,
                            width: 30,
                  ...
                  [
                    BlocConsumer<AppTypeBloc, AppTypeState>(
                      ...
                      builder: (context, state) {
                        return Column(
                          children: [
                            if (state is AppTypeProperty &&
                                state.appTypeEnum ==
                                    AppTypeEnum.propertyUser) ...[
                              Container(
  ...
  _floatingActionButton() {
    return BlocConsumer<AppTypeBloc, AppTypeState>(
      listener: (context, state) {},
      builder: (context, state) {
        return (state is AppTypeProperty &&
                state.appTypeEnum == AppTypeEnum.propertyVendor)
            ? FloatingActionButton(
                onPressed: () {
                  context.pushScreen(nextScreen: AddPropertyScreen());
                },
                child: Icon(
                  Icons.add,
                  color: Colors.white,
                ),
                backgroundColor: primaryColor, // Customize background color
              )
            : SizedBox.shrink();
      },
    );
